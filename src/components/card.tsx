...
export const Card = (
    ...
    return (
        <Link className="hover:shadow-none  bg-white shadow-md rounded-md border border-gray-100 hover:bg-blue-50 hover:border-blue-300 hover:cursor-pointer ease-in duration-200" href={href}>
            <div className={`p-4 ${isCompact ? "w-[300px] md:h-[300px] md:w-[300px]" : "h-[300px] md:h-[350px]"}`}>
                ...
                <div className={`${isCompact ? "line-clamp-2 h-[40px] md:h-[70px] " : "h-[70px] md:h-[100px] line-clamp-2 md:line-clamp-3"} font-semibold  text-lg text-gray-800 text-center py-3`}>
                    <h1>{title}</h1>
                </div>
