  ...
  return (
    <>
      ...
      <section className="pt-28 px-8 pb-28">
        ...
        <div className="text-center text-3xl pb-3 font-extrabold">複雑なコミットメッセージを簡単に美しく。</div>
        <div className="text-center text-3xl font-extrabold">あなたのためのコミットメッセージ作成をサポートします。</div>
        <div className="flex items-center justify-center max-full">
          <p className="text-center text-base  text-gray-600 pt-8 max-w-3xl ">
            HTMLのフォームに文章を入力するだけで、AngularやConventional Commitsのルールに従ったコミットメッセージが生成されます。
            開発プロジェクトを効果的に進め、整理された履歴を維持するために、ぜひメッセージテンプレートサービスMessage Recipeをお試しください。
          </p>
        </div>
      ...
      <section className="flex py-28 bg-sky-50 justify-center items-center">
        <h2 className="font-bold text-xl px-8 ">使い方</h2>
        <span className="font-semibold text-lg px-8 ">1st</span>
        <span className="font-semibold text-lg px-8 ">2nd</span>
        <span className="font-semibold text-lg px-8 ">3rd</span>
      </section>

      <section className="flex py-28 items-center flex-col justify-center">
        <h2 className="font-bold text-xl py-4 px-8 ">ルールを選ぶ</h2>
